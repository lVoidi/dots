...
theme.menu_fg_normal                            = "#d8dee9"
theme.menu_fg_focus                             = "#e5e9f0"
theme.menu_bg_normal                            = "#2e3440dd"
theme.menu_bg_focus                             = "#4c566add"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#535f7a", "") .. markup("#d8dee9", " %H:%M "))
